...
.DESCRIPTION
    ...
    Usage:
        .\run_experiment.ps1 -ConfigFile experiments\exp1_round_robin.json
        .\run_experiment.ps1 -ConfigFile experiments\exp1_round_robin.json -GamesPerPair 50 -SwapColors -Adjudicate
        .\run_experiment.ps1 -ConfigFile experiments\exp1_round_robin.json -OpeningsFile experiments\openings_eco25.fen
